        ...
        <main>
            ...
            if ($velos && is_array($velos)) {
                foreach ($velos as $velo) {
                    ...
                    echo '<a href="/commander/' . $velo['id_v'] . '"><button class="bouton-achat">Commander</button></a>';
                    echo '<span class="espace-entre-boutons"></span>';
                    echo '<a href="/velo/' . $velo['id_v'] . '"><button class="bouton-achat">Détails</button></a>';
                    echo "</div>";
                    echo "<hr>";
                }
            } else {
